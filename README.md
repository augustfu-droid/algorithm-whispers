...
## 📐 数学卷 [`mathvol.pdf`](./mathvol.pdf) — 70 页 (v1.1 · 7 章镜像主本)
...
7. **后 Transformer 时代的数学——状态空间模型、线性注意力与扩散语言模型**（新：HiPPO LegS 矩阵推导、S4 ZOH 离散化、Mamba 并行扫描关联律、GLA/SSD 统一视角、DDPM/MDLM）
